...
local android_developers = {
	"Sergcomp <mobilecraft.project@gmail.com>",
}
...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		return "label[0.1,0;MobileCraft, ver. 1.0]" ..
			"label[0.1,0.3;]" ..
			"label[0.1,0.5;https://mobilecraftproject.wixsite.com/home" ..
			...
			"#FFFF00," .. fgettext("MobileCraft(ANDROID) Developers") .. ",," ..
